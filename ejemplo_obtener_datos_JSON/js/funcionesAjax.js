document.addEventListener("DOMContentLoaded",function(){
    ...
    let buscador = document.getElementById("formularioBuscar");
...
function buscadorElemento() {
      let divResultado =  document.getElementById("resultadoBuscador");
    divResultado.innerHTML = "";
    document.getElementById("spinner").style ="display:block";
    miXHR = new objetoXHR();
    miXHR.open("GET", "servidor/formularioBuscar.php?nombre="+nombre, true);
    miXHR.onreadystatechange = comprobarEstadoPeticion;
    miXHR.send(null);
}
...
function crearTablaJSON(respuesta){
    ...
    for (let i=0; i < resultados.length; i++){
        ...
        objeto.genero+"</td><td>"+objeto.direccion+"</td><td>"+
